...
Memory_manager* memory_manager_create(int num_node_slots)
{
    ...
    memory_manager->output_strength_weights = array_2d_create(num_node_slots, 128);
...
int memory_manager_next_node_get(Memory_manager* memory_manager, Array_1d* active_memories, Array_1d* active_memories_sorted_index)
{
    ...
    // Array_1d* columns[num_columns];
    // for (int i = 0; i < num_columns; i++)
    //     columns[i] = array_2d_column_get(new_filtered_connection_weights, i);
    
    // float sum_values[num_columns];
    // for (int i = 0; i < num_columns; i++)
    // {
    //     sum_values[i] = array_1d_sum(columns[i]);
    // }
    ...
    // for (int i = 0; i < num_columns; i++)
    // {
    //     if (sum_values[i] > max_value)
    //     {
    //         max_value = sum_values[i];
    //         max_index = i;
    //     }
    // }
...
int memory_manager_next_output_get(Memory_manager* memory_manager, Array_1d* active_memories)
{
    Array_2d* filtered_output_strength_weights = array_2d_rows_get(memory_manager->output_strength_weights, active_memories);
    ...
    // Array_1d* columns[num_columns];
    // for (int i = 0; i < num_columns; i++)
    //     columns[i] = array_2d_column_get(filtered_output_strength_weights, i);
...
void memory_manager_output_weights_update(Memory_manager* memory_manager, Array_1d* active_memories, int y, int y_pred)
{
    // y -= 32;

    // printf("y: %c, y_pred: %c\n", y, y_pred);
    // printf("y_i: %i, y_pred_i: %i\n", y, y_pred);
    // printf("\n");
    ...
    for (int i = 0; i < active_memories->length; i++)
    {
        ...
        memory_manager->output_strength_weights->data[memory_index][y_pred] += update_amount;
    }
}
...
int main()
{
    ...
    // array_2d_assign_range(memory_manager1->connection_strength_weights);
    // array_2d_print(memory_manager1->connection_strength_weights);
    // printf("\n");

    // array_list_print_all(memory_manager1->node_list);
    // array_list_print(memory_manager1->node_list);
    // printf("\n");
    ...
    // memory_manager_node_remove(memory_manager1, 2);
    // memory_manager_node_remove(memory_manager1, 3);
    ...
    // memory_manager1->connection_strength_weights->data[2][1] = (float)666;
    // memory_manager1->connection_strength_weights->data[2][2] = (float)10000;
    // array_2d_print(memory_manager1->connection_strength_weights);
    // printf("\n");

    // array_queue_enqueue(memory_manager1->recent_active_memory_queue, 10);
    // array_queue_enqueue(memory_manager1->recent_active_memory_queue, 15);
    // array_queue_enqueue(memory_manager1->recent_active_memory_queue, 32);
    // array_queue_print(memory_manager1->recent_active_memory_queue);
    ...
    char xs[] = "";
    ...
    for (int i = 0; xs[i] != 0; i++)
    {
        ...
        Array_1d* active_memories = array_queue_to_array_1d(memory_manager1->recent_active_memory_queue);
        Array_1d* active_memories_sorted_index = memory_manager_argsort(active_memories);
        // for (int i = 0; i < active_memories->length; i++)
        // {
        //     active_memories->data[i] -= 32;
        // }

        if (output_updating == true)
        {
            memory_manager_output_weights_update(memory_manager1, active_memories, x, y_pred);
        }

        // int max_node_index = memory_manager_next_node_get(memory_manager1, active_memories, active_memories_sorted_index);
        int max_output_index = memory_manager_next_output_get(memory_manager1, active_memories);
