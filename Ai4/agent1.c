...
int agent_output_get(Agent* agent, Array_1d* sorted_active_memories)
{
...
int main()
{
    ...
    for (int i = 0; xs[i] != 0; i++)
    {
        ...
        Array_1d* active_memories_sorted_index = agent_active_memories_argsort(sorted_active_memories);
        ...
        //// GET OUTPUT
        int max_output_index = agent_output_get(agent1, sorted_active_memories);
